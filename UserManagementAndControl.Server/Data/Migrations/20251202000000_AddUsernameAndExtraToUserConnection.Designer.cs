...
namespace UserManagementAndControl.Server.Migrations
{
    ...
    [Migration("20251202000000_AddUsernameAndExtraToUserConnection")]
    partial class AddUsernameAndExtraToUserConnection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagementAndControl.Server.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UserManagementAndControl.Server.Data.ApplicationUser", null)
                        .WithMany()
