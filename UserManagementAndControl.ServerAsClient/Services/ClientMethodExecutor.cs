...
/// <summary>
/// Handles method invocations from the server
/// </summary>
public class ClientMethodExecutor : IMethodExecutor
{
    ...
    private Task<object?> HandleAlertAsync(object? parameter)
    {
        ...
        // In a real app, this could trigger a UI notification
    ...
    private Task<object?> HandleNavigateAsync(object? parameter)
    {
        ...
        // In a real app, this could trigger navigation
    ...
    private Task<object?> HandleGetClientInfoAsync()
    {
        ...
        {
            platform = "Blazor Server (as Client)",
            userAgent = "UserManagementAndControl.ServerAsClient",
    ...
    private async Task<object?> HandleLogoutAsync()
    {
        ...
        // Home.razor subscribes to that event to handle UI logout
    ...
    private Task<object?> HandleGetLargeDataAsync(object? parameter)
    {
        ...
        // Generate large dataset that will exceed MaxDirectDataSizeBytes (default 32KB)
